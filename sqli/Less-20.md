...
设置一个cookie为uname，并在post数据里去除submit。

isset() 用来判断变量是否设置而不是判断null。

![image-20210116104938604](D:\WEB安全\笔记\image\image-20210116104938604.png)

![image-20210116104948198](D:\WEB安全\笔记\image\image-20210116104948198.png)



## 0x01 分析

无法从post注入，因为服务器对post数据进行处理。

服务器先判断是否设置了cookie。

如果没有，就使用post数据。

如果有，就判断是否设置了submit数据。
